...
import io.element.android.features.roomdetails.impl.admin.changeroles.ChangeRolesNode
...
class RoomDetailsAdminSettingsFlowNode @AssistedInject constructor(
    @Assisted buildContext: BuildContext,
    @Assisted plugins: List<Plugin>,
) : BaseFlowNode<RoomDetailsAdminSettingsFlowNode.NavTarget>(
    backstack = BackStack(
    ...
    override fun resolve(navTarget: NavTarget, buildContext: BuildContext): Node {
        return when (navTarget) {
            is NavTarget.AdminSettings -> {
                val callback = object : RoomDetailsAdminSettingsNode.Callback {
                ...
                createNode<RoomDetailsAdminSettingsNode>(
                    buildContext = buildContext,
